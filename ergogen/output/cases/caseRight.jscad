function _standoffRight_extrude_4_outline_fn(){
...
function _mountingRight_extrude_4_outline_fn(){
    return CAG.circle({"center":[319.075,-85.475],"radius":1.5})
.union(
    CAG.circle({"center":[278.9299884,-139.8551139],"radius":1.5})
).union(
    CAG.circle({"center":[301.1902283,-120.4810859],"radius":1.5})
).union(
    CAG.circle({"center":[376.225,-86.665],"radius":1.5})
).union(
    CAG.circle({"center":[319.075,-62.615],"radius":1.5})
).union(
    CAG.circle({"center":[376.225,-67.615],"radius":1.5})
).extrude({ offset: [0, 0, 4] });
}
...
.extrude({ offset: [0, 0, 5.6] });
                ...
                let _standoffsRight__part_0 = _standoffRight_extrude_4_outline_fn();
                ...
                let _holesRight__part_0 = _mountingRight_extrude_4_outline_fn();
